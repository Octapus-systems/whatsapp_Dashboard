...
Wirebot supports multiple infrastructure configurations. Choose based on your needs:
...
DATABASE_URL=postgresql://wirebot:wirebot@localhost:5432/wirebot
...
docker run --shm-size=2gb wirebot
```
