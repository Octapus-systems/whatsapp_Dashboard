...
```mermaid
timeline
    title Wirebot Release Timeline
...
├── Docker image (ghcr.io/rmyndharis/wirebot:0.0.1)
├── docker-compose.yml
...
├── Docker image (ghcr.io/rmyndharis/wirebot:0.0.2)
...
├── Docker image (ghcr.io/rmyndharis/wirebot:0.1.0)
