...
<p align="center">
  <img src="../docs/logo/wirebot_logo.webp" alt="Wirebot Logo" width="120"/>
</p>

Modern web dashboard for managing Wirebot WhatsApp API Gateway sessions, webhooks, and infrastructure.
...
The dashboard connects to the Wirebot API backend. Configure the API URL in environment variables:
